...
export function PurchaseRequestDetail({
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await fetch(
        `/api/pt-pks/gudang/purchase-request/${purchaseRequest.id}/submit`,
        { method: "POST" }
      );
  ...
  const handleApprove = async () => {
    ...
    try {
      const response = await fetch(
        `/api/pt-pks/gudang/purchase-request/${purchaseRequest.id}/approve`,
        {
          method: "POST",
  ...
  const handleReject = async () => {
    ...
    try {
      const response = await fetch(
        `/api/pt-pks/gudang/purchase-request/${purchaseRequest.id}/reject`,
        { method: "POST" }
      );

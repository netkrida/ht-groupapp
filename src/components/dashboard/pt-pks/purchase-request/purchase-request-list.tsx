    ...
    <Card>
      <CardHeader>
        <div className="flex items-center justify-between">
          ...
          <Button onClick={() => router.push('/dashboard/pt-pks/gudang/purchase-request/create')}>
                ...
                {filteredPurchaseRequests.length === 0 ? (
                  ...
                  filteredPurchaseRequests.map((pr) => (
                    <TableRow key={pr.id}>
                      ...
                      <TableCell>
                        <Badge variant={pr.tipePembelian === "PEMBELIAN_LANGSUNG" ? "default" : "outline"}>
                          {pr.tipePembelian === "PEMBELIAN_LANGSUNG" ? "Beli Langsung" : "Pengajuan PO"}
                        </Badge>
                      </TableCell>
